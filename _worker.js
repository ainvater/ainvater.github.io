...
<meta property="og:site_name" content="collection.dempil.co">
...
breadcrumbBox.setAttribute("dir", (lang === "ar" || lang === "he") ? "rtl" : "ltr");
...
export default {
	async fetch(request, env, ctx) {
		...
		if (!self.verificationList) {
		  ...
		  const res = await fetch("https://collection.dempil.co/url-sitemap.txt");
		...
		if (pathname === "/googlee808fac5dc03b532.html") {
			const fileRes = await fetch("https://nde.buytostore.com/googlee808fac5dc03b532.html");
...
<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<title>collection.dempil.co</title>
<meta name="robots" content="noindex, follow" />
<meta name="description" content="Find your dream product from thousands of deals. Shop smarter, live better with collection.dempil.co." />
...
<body>
<div class="logo" id="logo">collection.dempil.co</div>
...
const logoText = "collection.dempil.co";
...
`;
		...
		const staticExtensions = ['.ico', '.txt', '.txt.gz', '.xml', '.xml.gz', '.ainvater'];
